...
export function Chat({
  ...
  return (
    <div className="fixed inset-0 top-14 bg-dot-black/[0.2] dark:bg-zinc-900 pt-2 pb-6">
      <div className="max-w-2xl h-full mx-auto px-4">
        <div className="bg-fade-bottom dark:bg-zinc-800 rounded-lg shadow-lg border border-zinc-200 dark:border-zinc-700 h-full flex flex-col">
